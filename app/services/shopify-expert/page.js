  ...
  return (
    <>
      <section className="svc-hero">
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          ...
          <h1 className="svc-hero-title">
            E-Commerce <span className="gradient-text">Stores</span><br />
            That Convert
          </h1>
      ...
      <section className="svc-process">
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <div className="svc-section-header">
            ...
            <h2 className="svc-section-title">From Concept to <span className="gradient-text">Sales</span></h2>
            <p className="svc-section-subtitle">A proven, conversion-first approach to launching your dream online store.</p>
          </div>
          <div className="svc-timeline">
            {[
              { num: '01', title: 'Brand Discovery', desc: 'We analyze your products, audience, and competitors to define a winning eCommerce strategy.', icon: '🎯' },
              { num: '02', title: 'Design & Build', desc: 'UI/UX design focused on high-conversion paths and bespoke theme development in Liquid.', icon: '🏗️' },
              { num: '03', title: 'Setup & Integrations', desc: 'Product uploads, payment gateway config, and connecting your essential marketing apps.', icon: '🔗' },
              { num: '04', title: 'Testing & Launch', desc: 'Rigorous cross-device testing and performance tuning before the grand store opening.', icon: '🚀' },
            ].map((step, i) => (
      ...
      <section className="svc-features" style={{ paddingTop: '40px' }}>
        <div className="container">
          ...
          <div className="svc-tech-grid">
            {[
              { name: 'Shopify Plus', icon: '🛍️', color: '#96BF48' },
              { name: 'Liquid', icon: '💧', color: '#00A4BD' },
      ...
      <style jsx>{`
        ...
        .svc-hero-orb-1 { width: 600px; height: 600px; background: rgba(150, 191, 72, 0.15); top: -200px; right: -100px; }
        ...
        .svc-process-bg { position: absolute; inset: 0; background: radial-gradient(circle at 30% 50%, rgba(150, 191, 72, 0.05), transparent 60%), radial-gradient(circle at 70% 50%, rgba(0, 212, 170, 0.04), transparent 60%); pointer-events: none; }
        ...
        .svc-cta-orb-1 { width: 500px; height: 500px; background: rgba(150, 191, 72, 0.12); top: -100px; left: 20%; animation: floatOrb 6s ease-in-out infinite; }
