    ...
    <>
      <section className="svc-hero">
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <div className="svc-hero-badge"><span className="svc-hero-badge-dot" />Angular Development</div>
          ...
          <div className="svc-hero-stats">
            {[{ num: '20+', label: 'Angular Apps' }, { num: '99.9%', label: 'Uptime' }, { num: '50ms', label: 'Response Time' }].map((s, i) => (
      ...
      <section className="svc-features">
        <div className="container">
          <div className="svc-section-header">
            ...
            <h2 className="svc-section-title">Angular <span className="gradient-text">Superpowers</span></h2>
            <p className="svc-section-subtitle">Robust, modular applications engineered for complex business logic and seamless performance.</p>
          </div>
          <div className="svc-features-grid">
            {[
              { icon: '🏗️', title: 'Modular Architecture', desc: 'Lazy-loaded modules, shared libraries, and clean separation of concerns for maximum maintainability.', color: '#DD0031' },
              { icon: '🔗', title: 'API Integrations', desc: 'Seamless REST and GraphQL integrations with interceptors, error handling, and NgRx state management.', color: '#00D4AA' },
              { icon: '📊', title: 'Enterprise Dashboards', desc: 'Complex data visualizations, real-time dashboards, and admin panels with Angular Material and PrimeNG.', color: '#6C63FF' },
              { icon: '🧪', title: 'Testing & Quality', desc: 'Comprehensive unit tests with Jasmine/Karma, E2E tests with Cypress, and CI/CD pipeline integration.', color: '#FFB800' },
              { icon: '🔄', title: 'RxJS & Reactive', desc: 'Reactive programming patterns with RxJS for handling complex async operations and real-time data streams.', color: '#4ECDC4' },
              { icon: '📱', title: 'Progressive Web Apps', desc: 'Angular PWAs with offline support, push notifications, and native-like experiences on mobile devices.', color: '#F093FB' },
            ].map((item, i) => (
      ...
      <section className="svc-process">
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <div className="svc-section-header">
            ...
            <h2 className="svc-section-title">Development <span className="gradient-text">Workflow</span></h2>
            <p className="svc-section-subtitle">A structured, agile approach to building robust Angular applications.</p>
          </div>
          <div className="svc-timeline">
            {[
              { num: '01', title: 'Requirements & Planning', desc: 'Deep-dive into business requirements, user stories, component architecture, and state management strategy.', icon: '📋' },
              { num: '02', title: 'Component Design', desc: 'Designing reusable smart and dumb components with clean interfaces and dependency injection patterns.', icon: '🧩' },
              { num: '03', title: 'Agile Development', desc: 'Sprint-based development with regular demos, code reviews, and iterative feedback loops.', icon: '💻' },
              { num: '04', title: 'CI/CD Deployment', desc: 'Automated deployment pipelines with monitoring, logging, error tracking, and ongoing support.', icon: '🚀' },
            ].map((step, i) => (
      ...
      <section className="svc-features" style={{ paddingTop: '40px' }}>
        <div className="container">
          <div className="svc-section-header"><span className="section-label">Technologies</span><h2 className="svc-section-title">Our Tech <span className="gradient-text">Arsenal</span></h2></div>
          <div className="svc-tech-grid">
            {[
              { name: 'Angular', icon: '🅰️', color: '#DD0031' },{ name: 'TypeScript', icon: '📘', color: '#3178C6' },{ name: 'RxJS', icon: '🔄', color: '#B7178C' },{ name: 'NgRx', icon: '📦', color: '#BA2BD2' },
              { name: 'Material', icon: '🎨', color: '#757575' },{ name: 'PrimeNG', icon: '⭐', color: '#DD0031' },{ name: 'Cypress', icon: '🧪', color: '#17202C' },{ name: 'Jasmine', icon: '💜', color: '#8A4182' },
            ].map((tech, i) => (
