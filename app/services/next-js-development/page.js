      ...
      <section className="svc-hero">
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          ...
          <h1 className="svc-hero-title">
            Full-Stack <span className="gradient-text">React Apps</span><br />
            Built for Scale
          </h1>
          <p className="svc-hero-desc">
            SEO-optimized, server-rendered React applications with blazing-fast performance. 
          ...
          <div className="svc-hero-stats">
            {[
              { num: '30+', label: 'Next.js Projects' },
              { num: '100', label: 'Lighthouse Score' },
              { num: '0.3s', label: 'Avg TTFB' },
            ].map((s, i) => (
      ...
      <section className="svc-features">
        <div className="container">
          <div className="svc-section-header">
            ...
            <h2 className="svc-section-title">Next.js <span className="gradient-text">Superpowers</span></h2>
            <p className="svc-section-subtitle">Harness the full power of the React ecosystem for production-grade applications.</p>
          </div>
          <div className="svc-features-grid">
            {[
              { icon: '🚀', title: 'Server-Side Rendering', desc: 'Dynamic pages rendered on the server for blazing-fast initial loads and perfect SEO scores across all search engines.', color: '#6C63FF' },
              { icon: '📄', title: 'Static Site Generation', desc: 'Pre-rendered pages at build time for maximum speed. Ideal for blogs, marketing sites, and documentation portals.', color: '#00D4AA' },
              { icon: '🔌', title: 'API Routes & Backend', desc: 'Full-stack capabilities with serverless API routes. No need for a separate backend — everything in one project.', color: '#FFB800' },
              { icon: '🌐', title: 'SEO & Performance', desc: 'Built-in image optimization, automatic code splitting, and metadata management for top Google rankings.', color: '#FF6B6B' },
              { icon: '⚡', title: 'Incremental Regeneration', desc: 'ISR lets you update static content without rebuilding. Get the speed of static with the flexibility of dynamic.', color: '#4ECDC4' },
              { icon: '🔐', title: 'Auth & Middleware', desc: 'Secure authentication flows, role-based access control, and edge middleware for personalized experiences.', color: '#F093FB' },
            ].map((item, i) => (
      ...
      <section className="svc-process">
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <div className="svc-section-header">
            ...
            <h2 className="svc-section-title">From Concept to <span className="gradient-text">Deployment</span></h2>
            <p className="svc-section-subtitle">A streamlined workflow optimized for Next.js projects.</p>
          </div>
          <div className="svc-timeline">
            {[
              { num: '01', title: 'Architecture Planning', desc: 'We plan page structure, data fetching strategy (SSR/SSG/ISR), API routes, and database schema.', icon: '🏗️' },
              { num: '02', title: 'Component Development', desc: 'Reusable React components with TypeScript, proper state management, and responsive design.', icon: '⚛️' },
              { num: '03', title: 'Backend Integration', desc: 'APIs, headless CMS, databases, authentication, and third-party services seamlessly connected.', icon: '🔗' },
              { num: '04', title: 'Deploy on Vercel', desc: 'CI/CD deployment to Vercel or custom infrastructure with preview builds and monitoring.', icon: '🚀' },
            ].map((step, i) => (
